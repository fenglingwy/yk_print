...
//        r.write(out);
//        EventBus.getDefault().post(new PrintMsgEvent(PrinterMsgType.MESSAGE_PRINTER_SUCCESS, "打印成功!"));
//
//    }
//
//    /**
...
//        EventBus.getDefault().post(new PrintMsgEvent(PrinterMsgType.MESSAGE_PRINTER_FAIL, "蓝牙连接失败,请重启打印机再试"));
//        setState(STATE_NONE);
